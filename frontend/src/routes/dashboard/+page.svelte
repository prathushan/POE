...
<div class="auth-wrapper">
  <div class="auth-card">
    ...
    <label>DEF14A Link <span class="req">*</span></label>
    ...
    <textarea bind:value={description} placeholder="Optional details"
    ></textarea>
    ...
    <button class="btn-auth" on:click={submitFiling}> SUBMIT FILING </button>
  </div>
</div>
<style>
  .req {
